...
\textbf{Objective:} Compute transformations necessary to align adjacent pairs of images. \\
\begin{enumerate}
...
\textbf{Objective:} Determine transformations necessary to align image pair. \\
\\
